                    ...
                    <div className="col l-2-4 m-4 c-6">
                        ...
                        <ul className="footer-list">
                            <li className="footer-list__shipping">
                                <img src={shopeeExpress} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={giaoHangTietKiem} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={giaoHangNhanh} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={vtPost} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={vnPost} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={jTExpress} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={grabExpress} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={ninjaVan} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={bestExpress} alt="" className="footer-list__shipping-img" />
                            </li>
                            <li className="footer-list__shipping">
                                <img src={Be} alt="" className="footer-list__shipping-img" />
                            </li>
                        </ul>
                    </div>
                    <div className="col l-2-4 m-4 c-6">
