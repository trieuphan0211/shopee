                    ...
                    <div className="header__notify">
                        ...
                        <li className="header__notify-item header__notify-item--viewed">
                            ...
                            <div className="header__notify-info">
                                ...
                                Bảo trì hệ thống SPayLater
                                </span>
                                <span className="header__notify-descriotion">
                                Từ 21h30 ngày 20/1 đến 14h30 ngày 23/1, bạn có thể
                                không kích hoạt được SPayLater do bảo trì hệ thống.
                                Hãy quay lại sau thời gian trên nhé!
                                </span>
                            </div>
                            </a>
                        </li>
                        <li className="header__notify-item">
                            ...
                            <div className="header__notify-info">
                                <span className="header__notify-name">
                                MUA HÀNG HOÀN ĐẾN 50.000XU
                                </span>
                                <span className="header__notify-descriotion">
                                Voucher hoàn đến 50.000 Xu đơn từ 250.000Đ. Mã hoàn
                                đến 40.000 Xu. Thêm mã 10.000Đ đơn từ 150.000Đ. Mua
                                hàng xuyên Tết, Shopee có hết
                                </span>
                            </div>
                            </a>
                        </li>
                        <li className="header__notify-item header__notify-item--viewed">
                            ...
                            <div className="header__notify-info">
                                <span className="header__notify-name">
                                TẾT SALE HÀNG HIỆU TỚI 50%
                                </span>
                                <span className="header__notify-descriotion">
                                Quạt Fujihome, tẩy trang Bioderma... Thêm Voucher
                                50.000 Xu hấp dẫn. Tết sẵn hàng hiệu, Sắm hàng cực
                                điệu
                                </span>
                            </div>
                            </a>
